...
window.onload = function () {
  console.log('TS for shortyRS loaded.'); // set custom short url prefix display

  var prefixDisplay = document.getElementById('url-prefix');
  prefixDisplay.textContent = location.host + "/"; // --- long url ---

  var longUrlInput = document.getElementById('long-url');
  var longValidityInfo = document.getElementById('long-validity-message');
  ...
  longUrlInput.oninput = validateLong; // --- custom short url ---

  var useCustomUrlButton = document.getElementById('provide-short-url');
  var customUrlInput = document.getElementById('short-url');
  var shortValidityInfo = document.getElementById('short-validity-message');
  ...
  useCustomUrlButton.onchange = function (evt) {
    var use = useCustomUrlButton.checked;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "15916" + '/');
...
//# sourceMappingURL=/page.77de5100.js.map